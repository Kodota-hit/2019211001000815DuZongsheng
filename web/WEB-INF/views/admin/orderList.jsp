			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.DuZongsheng.model.Order o=(com.DuZongsheng.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.DuZongsheng.dao.UserDao userDao=new com.DuZongsheng.dao.UserDao();
						...
						<%
							...
							String paymentType=com.DuZongsheng.model.Payment.findByPaymentId(con,n);
							 %>
