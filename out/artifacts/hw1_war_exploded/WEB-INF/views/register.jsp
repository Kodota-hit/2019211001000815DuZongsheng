...
style="width: 15px; height: 15px; display:inline;" name="gender" value="boy" checked/>&nbsp;Male&nbsp;<input type="radio" style="width: 15px; height: 15px;   display: inline;" name="gender" value="girl"/>&nbsp;Female</span>
   <span></span>
