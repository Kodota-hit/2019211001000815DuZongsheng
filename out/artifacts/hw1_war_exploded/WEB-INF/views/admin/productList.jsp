<%@ page import="com.DuZongsheng.model.Product" %>
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<%
								com.DuZongsheng.model.Product p= (com.DuZongsheng.model.Product) pageContext.findAttribute("p");
								int pid=p.getCategoryID();
								java.sql.Connection con= (Connection) application.getAttribute("con");
								String catName=com.DuZongsheng.model.Category.findByCategoryId(pid,con);
							%>
